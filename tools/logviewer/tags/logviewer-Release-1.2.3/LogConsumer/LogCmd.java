...
public class LogCmd extends Command implements TangoConst
{
	//===============================================================
	/**
	 *	Constructor for Command class LogCmd
	 *
	 ...
	 */
	//===============================================================
	public LogCmd(String name,int in,int out)
	{
		super(name, in, out);
	}
	 ...
	 */
	//===============================================================
	public LogCmd(String name,int in,int out, String in_comments, String out_comments)
	{
